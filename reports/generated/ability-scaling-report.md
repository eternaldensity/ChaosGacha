# ability scaling report (linked)

Auto-generated from `ability-scaling-report.md`. Entry names link to [entries/ability.md](entries/ability.md). Responses: [responses.tsv](responses.tsv).
...
|---|-------|-----|---------|---------|
| [267](entries/ability.md#267-black-hole) | Black Hole (trainable REAL black holes) | 5.0 | Planet-killer at Epic | → 8.5+ or virtual-only |
| [938](entries/ability.md#938-tinker-the-baker) | Tinker - The Baker (compress universes, atom-to-cookies) | 9.9 | Same joke-capstone disease as Spiral 9.9 (trait) | Defined set, nerf, or remove |
| [917](entries/ability.md#917-luck-manipulation) | Luck Manipulation | 9.7 | Luck-stat manip near top; vs item Draw of Fate 3.3? | Calibrate luck pricing cross-file |
...
| [1091](entries/ability.md#1091-tinker-vehicles-iv) | Vehicles (IV) | 6.7 | III→IV gap 2.6 (line norm ~1.2–1.5) | → ~5.5 or justify |
| [713](entries/ability.md#713-twice) | Twice (MHA cloning) | 8.3 | Clone cluster (401–403, 710–713) needs ordering; Twice above most | Confirm clone hierarchy + cross-check skill Clone Split |
| [682](entries/ability.md#682-tinker-capture-and-restraint) | Kyokai Suigetsu Shikai | 7.0 | Above most Bankai (cf. item-file Kyokai note) | Confirm hypnosis-vs-power ordering |
| [111](entries/ability.md#111-divinity-water-ice) | Divinity Water & Ice ("all that entails") | 8.0 | No mechanics (clarity blocker) | Concrete kit or cut |
| [548](entries/ability.md#548-wheel-of-mahoraga) | Wheel of Mahoraga | 8.2 | Adaptation engine + item Rinnegan Jar + familiar Mahoraga — three Mahoraga prices? | Cross-file parity check |
| [654](entries/ability.md#654-rinnegan) | Rinnegan (six-paths + Outer revive) | 8.8 | Bundle vs item Rinnegan Jar (implant) | Define bundle-vs-implant pricing |
| [731](entries/ability.md#731-divinity-fire) | Divinity Fire ("domain over ALL fire") | 8.5 | Overrides other fire users? | Capped rank/scope or override rules |
| [694](entries/ability.md#694-tinker-dreadon) | Dreadon (universe-range sniper, black-hole bombs) | 8.3 | Unpriceable open ceiling | Cap + arc-resource gating |
| [715](entries/ability.md#715-dark-matter) | Dark Matter (ANY property incl. life/clones/powers) | 9.5 | "Only limit is computational power" undefined | Whitelist + ban power-granting |
| [776](entries/ability.md#776-path-to-victory) | Path to Victory (one-in-googol, nigh-omniscient) | 9.6 | No blind-spot/cost/combat rule | Ban/restrict or full mechanic |
| 879/885 | Immortal (stats PER DEATH) / Level Up (10% per kill) | 9.7/— | Infinite farms | Remove scaling / cap / sapient-farm ban |
| [1324](entries/ability.md#1324-greater-guard) | Greater Guard (decapitation→nick transfer) | — | Inverted/lethal math | Rewrite, forbid lethal transfer |
...
| [947](entries/ability.md#947-d4c) | D4C (death-transfers whole gacha!) | 8.8 | Death immunity + multiverse import | Ban transfer, travel-only |
| [654](entries/ability.md#654-rinnegan) | (above) | — | — | — |
| [918](entries/ability.md#918-wrath) | Wrath (uncapped, universe-ending) | 8.8 | No cap, mindless-beast endstate | Hard cap + stop condition |
| 921-923 | Magic Dominion / Void / Nihil | 8.1–8.5 | Near-limitless nullification/suction | Rank-difference + touch-range caps |
| [958](entries/ability.md#958-rule-breaker) | Rule Breaker (remove gravity/magic/targetability…) | — | No table (remove death/costs?) | Whitelist + costs/durations |
| [1047](entries/ability.md#1047-choosing-fate) | Choosing Fate (enforce "absolutely improbable") | 8.5 | No cap/backlash/energy/paradox | Full mechanic or cut |
| [1079](entries/ability.md#1079-hulk-out) | Hulk Out (no discernible limit) | — | Infinite strength | Hard cap / rage decay / cost |
| [1071](entries/ability.md#1071-the-tinkerer) | The Tinkerer (ANY specialisation + multiversal/time) | 9.4 | Infinite breadth (Worm lore) | Whitelist + ban multiversal/time |
| [1112](entries/ability.md#1112-tinker-defence-v) | Defence (V) ("even gods cannot dent") | 8.6 | Unbreakable | Tier cap / counter |
| [1212](entries/ability.md#1212-authority-of-death) | Death Authority (point-to-kill, kill unkillable) | 9.4 | Immunity list? cost curve? | Full mechanic |
| [1350](entries/ability.md#1350-grand-dissolution) | Grand Dissolution (melts flesh/stone/magic/space) | — | Resists? volume/speed? | Full mechanic |
| [1211](entries/ability.md#1211-divinity-necromancy) | Necromancy (100k controllable base-human?!) | 8.5 | Number/power caps by energy? | Full mechanic |
| [1292](entries/ability.md#1292-inversion) | Inversion (Pyro→Cryo of ANY slotted ability) | — | Whitelist? Tinker/unique handling? | Whitelist / GM veto |
| [1298](entries/ability.md#1298-tower-down) | Tower Down (1km comms blackout, growing) | — | Scaling? allies? system/telepathy? | Full mechanic |
