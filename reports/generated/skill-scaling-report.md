# skill scaling report (linked)

Auto-generated from `skill-scaling-report.md`. Entry names link to [entries/skill.md](entries/skill.md). Responses: [responses.tsv](responses.tsv).
...
| [43](entries/skill.md#43-renewal-taekwondo) | Renewal Taekwondo | 6.6 | Outranks **Grandmaster** H2H (147, 6.5) | 6.4 (below Saint tier) |
| [45](entries/skill.md#45-suppression) | Suppression | 4.0 | Hides godlike presence — cheaper than Expert Stealth 4.7, far below Master Stealth 5.8 doing less | 5.2 |
...
| [242](entries/skill.md#242-intermediate-ninjutsu) | Intermediate Ninjutsu | 3.8 | Front-loaded line (2.0→3.8 gap 1.8), clusters at dumped-on 3.8 | 3.0–3.2 |
| [89](entries/skill.md#89-adept-item-construction) | Adept Item Construction | 4.9 | Equals 4 Expert entries (107/110/120 at 4.9); emergency fire-barrier crafting at Adept | 4.3 |
...
| # | Entry | Now | Problem | Suggest |
|---|-------|-----|---------|---------|
| [270](entries/skill.md#270-mental-image-blocking) | Mental Image Blocking | 1.9 | Blocks ALL mind readers at Common | 2.8, or "resists weak readers" clause |
| [301](entries/skill.md#301-tax-evasion) | Tax Evasion ("government sees no more than you allow") | 1.0 | Supernatural audit immunity at Common floor | Reword to mundane accounting (keep 1.0) or → 4.0+ as supernatural |
| [247](entries/skill.md#247-begging) | Begging ("most people grant request") | 2.4 | Mass mind-affecting at Uncommon | Add resistible/mundane-pity clause or → 3.2 |
| [299](entries/skill.md#299-judging) | Judging (morality + ill intent) | 2.7 | Undercuts Adept Communication intent-reading (3.6) by 0.9 | 3.4 + resisted-by-Acting/Stealth clause |
| [74](entries/skill.md#74-literacy) | Literacy (all world languages + grimoire speed-read) | 2.2 | Multi-skill bundle at Uncommon | 3.0 |
| [250](entries/skill.md#250-gooning) | Gooning (thug skills + novice knives/pistols/unarmed) | 2.3 | Combat bundle ≈ Novice Blade 1.9 + guns + H2H 1.5 for 2.3 | Strip weapon grants (→ 1.8) or price bundle → 2.8 |
| [297](entries/skill.md#297-hacking) | Hacking vs Intermediate Programming 2.1 | 2.5 | Applied breach costs more than its enabling skill but less than Adept 3.1 — inverted dependency | Gate behind Intermediate Programming, or → 3.0 standalone |
